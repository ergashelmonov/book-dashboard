...
import { delProducts, setDel } from "../../features";
import { AppDispatch } from "../../store";

export const DeletePopup = ({ id }: { id: number }) => {
  const dispatch = useDispatch<AppDispatch>();
  return (
    <div
      onClick={(e) => {
        e.target === e.currentTarget && dispatch(setDel(false));
      }}
